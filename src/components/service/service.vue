...
<template>
	<section
		id="features"
		class="container mx-auto px-4 space-y-6 bg-slate-950 py-8 md:py-12 lg:py-20"
	>
		<div
		...
		>
			<div
				class="relative overflow-hidden rounded-lg border bg-slate-950 select-none hover:shadow hover:shadow-teal-200 p-2"
			>
